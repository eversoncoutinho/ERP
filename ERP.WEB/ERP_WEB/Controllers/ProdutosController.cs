...
namespace ERP_WEB.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public ProdutosController(ERPDbContext context,
            IMapper mapper)
        {
            _context = context;
            _mapper = mapper;
        ...
        {
            var produtoVM = new ProdutoIndexVM()
            {
        ...
        public async Task<IActionResult> Create(ProdutoCreateVM produtoVM)
        {
            ProdutoCreateVM produtoCreateVM = new ProdutoCreateVM()
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Nome,DateTime,Price,Quantidade,Fornecedor,Id")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
